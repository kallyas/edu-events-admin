...
import {Dashboard,Events,Login,NewEvent,NotFound,UserList, Addproject, EditEvent } from './pages/index'
  ...
  return (
    <BrowserRouter>
      ...
      <Switch>
        ...
        <ProtectedRoute exact path={`${Routes.EditProject.path}/:id`} component={EditEvent} />
